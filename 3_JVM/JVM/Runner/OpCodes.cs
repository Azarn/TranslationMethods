...
namespace JVM.Runner {
    public class OpCodes {
        public static readonly IList<OpCode> ALL = new List<OpCode>() {
            ...
            new OpCode { Name = OpCodeName.dup, Value = 0x59, OperandSize = 0, StackChange = 1 },
            ...
            new OpCode { Name = OpCodeName.iand, Value = 0x7e, OperandSize = 0, StackChange = -1 },
            ...
            new OpCode { Name = OpCodeName.ineg, Value = 0x74, OperandSize = 0, StackChange = 0 },
            new OpCode { Name = OpCodeName.isub, Value = 0x64, OperandSize = 0, StackChange = -1 },
            new OpCode { Name = OpCodeName.ixor, Value = 0x82, OperandSize = 0, StackChange = -1 },
            new OpCode { Name = OpCodeName.if_icmpeq, Value = 0x9f, OperandSize = 2, StackChange = -2 },
            new OpCode { Name = OpCodeName.if_icmpne, Value = 0xa0, OperandSize = 2, StackChange = -2 },
            new OpCode { Name = OpCodeName.if_icmpge, Value = 0xa2, OperandSize = 2, StackChange = -2 },
            new OpCode { Name = OpCodeName.if_icmpgt, Value = 0xa3, OperandSize = 2, StackChange = -2 },
            new OpCode { Name = OpCodeName.if_icmple, Value = 0xa4, OperandSize = 2, StackChange = -2 },
            new OpCode { Name = OpCodeName.if_icmplt, Value = 0xa1, OperandSize = 2, StackChange = -2 },
            new OpCode { Name = OpCodeName.ifeq, Value = 0x99, OperandSize = 2, StackChange = -1 },
            new OpCode { Name = OpCodeName.ifge, Value = 0x9c, OperandSize = 2, StackChange = -1 },
            new OpCode { Name = OpCodeName.ifgt, Value = 0x9d, OperandSize = 2, StackChange = -1 },
            new OpCode { Name = OpCodeName.ifle, Value = 0x9e, OperandSize = 2, StackChange = -1 },
            new OpCode { Name = OpCodeName.iflt, Value = 0x9b, OperandSize = 2, StackChange = -1 },
            ...
            new OpCode { Name = OpCodeName.ior, Value = 0x80, OperandSize = 0, StackChange = -1 },
            ...
            new OpCode { Name = OpCodeName.pop, Value = 0x57, OperandSize = 0, StackChange = -1 },
