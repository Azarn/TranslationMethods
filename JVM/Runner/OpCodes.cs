...
namespace JVM.Runner {
    public class OpCodes {
        public static readonly IList<OpCode> ALL = new List<OpCode>() {
            ...
            new OpCode { Name = OpCodeName.dload_1, Value = 0x27, OperandSize = 0 },
            new OpCode { Name = OpCodeName.dload_2, Value = 0x28, OperandSize = 0 },
            new OpCode { Name = OpCodeName.dload_3, Value = 0x29, OperandSize = 0 },
            new OpCode { Name = OpCodeName.dstore, Value = 0x39, OperandSize = 1 },
            new OpCode { Name = OpCodeName.dstore_0, Value = 0x47, OperandSize = 0 },
            ...
            new OpCode { Name = OpCodeName.ldc2_w, Value = 0x14, OperandSize = 2 },
